...
\subsection*{MATLAB Code Repo:}
\begin{par}
Matlab code and reference files can be made found at \url{https://github.com/llyando/EECE4512}, specifically cloning the entire repo and running the code from LAB04.m, first section, to repeatthe results in this report.
\end{par}
\end{document}